...
$your_email ='dengy@hawaii.edu';// <<=== update to your email address
...
/**	if(empty($name)||empty($visitor_email))
	...
	if(empty($errors))
	{
		//send the email
		$to = $your_email;
		$subject="BQHS Bioinformatics Core Request";
		$from = $txtEmail;
		...
		$body = "Aloha BQHS Bioinformatics Core,\n\n\n".
