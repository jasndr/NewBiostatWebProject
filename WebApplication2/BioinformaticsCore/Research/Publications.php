...
<!-- ######################################################################
     ...
     # @date November 2016                                                #
     # Publications - Bioinformatics Core                                 #
     ###################################################################### -->
<html>

<head>
    <title>Publications | Bioinformatics Core | BQHS</title>
    <link rel="icon" href="../../images/Logo_Final.png" />
	<meta charset="utf-8" />
	<meta http-equiv="X-UA-Compatible" content="IE=10; IE=9; IE=8; IE=7; IE=EDGE" />
    <meta name="description" content="Who are we?" />
    <meta name="keywords" content="Publications, Bioinformatics Core, BQHS, About, Biostatistics, Quantitative Health Sciences, Hawaii, University of Hawaii, John A. Burns School of Medicine" />
...
<body id="bi-research">
    ...
    <!-- Breadcrumb/Navigational Hierarchy -->
            <div class="hierarchy breadcrumbNav realBreadcrumbNav">
                <ol class="breadcrumb">
                    ...
                    <li class="currentLink"><a href="./Publications.php">Publications</a></li>
                </ol>
            </div><!-- (End Breadcrumb) -->
    ...
    <div class="container mainBody fakeMenuReplace" id="activebirhPB">
    ...
    <div class="mainInfo">
        ...
        <div class="rightBank">
            ...
            <!-- Title of Page -->
            <div class="titleOfPage"><p>Publications</p></div>
            ...
            <div class="contentOfPage"> 
                ...
                <p class="contentWords"><em>[List of publications are currently being accumulated.  Please return at a later time.]</em>
                </p>
