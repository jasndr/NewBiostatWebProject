...
<!-- ######################################################################
     ...
     # @date November 2016                                                #
     # Collaborative Research - Bioinformatics Core                       #
     ###################################################################### -->
<html>

<head>
    <title>Collaborative Research | Bioinformatics Core | BQHS</title>
    <link rel="icon" href="../../images/Logo_Final.png" />
	<meta charset="utf-8" />
	<meta http-equiv="X-UA-Compatible" content="IE=10; IE=9; IE=8; IE=7; IE=EDGE" />
    <meta name="description" content="Who are we?" />
    <meta name="keywords" content="Collaborative Research, Bioinformatics Core, BQHS, About, Biostatistics, Quantitative Health Sciences, Hawaii, University of Hawaii, John A. Burns School of Medicine" />
...
<body id="bi-services">
    ...
    <!-- Breadcrumb/Navigational Hierarchy -->
            <div class="hierarchy breadcrumbNav realBreadcrumbNav">
                <ol class="breadcrumb">
                    ...
                    <li class="currentLink"><a href="./Collaborative Research.php">Collaborative Research</a></li>
                </ol>
            </div><!-- (End Breadcrumb) -->
    ...
    <div class="container mainBody fakeMenuReplace" id="activebisCR">
        ...
        <div class="mainContent container-fluid">
            ...
            <div class="hierarchy breadcrumbNav realBreadcrumbNav">
                <ol class="breadcrumb">
                    <li><a href="./index.html">Services</a></li>
                    <li class="currentLink"><a href="./CollaborativeResearch.php">Collaborative Research</a></li>
                </ol>
    ...
    <div class="mainInfo">
        ...
        <div class="rightBank">
            ...
            <!-- Title of Page -->
            <div class="titleOfPage"><p>Collaborative Research</p></div>
            ...
            <div class="contentOfPage"> 
                ...
                <p class="contentWords">We have been involved in collaborative research of several PIs from or across different UH departments and campuses.
				 We perform bioinformatics data analysis by both running routine bioinformatics application and custom program developed to specific purpose
