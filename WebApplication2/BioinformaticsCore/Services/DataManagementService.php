...
<!-- ######################################################################
     ...
     # @date November 2016                                                #
     # Data Management Service- Bioinformatics Core                       #
     ###################################################################### -->
<html>

<head>
    <title>Data Management Service | Bioinformatics Core | BQHS</title>
    <link rel="icon" href="../../images/Logo_Final.png" />
	<meta charset="utf-8" />
	<meta http-equiv="X-UA-Compatible" content="IE=10; IE=9; IE=8; IE=7; IE=EDGE" />
    <meta name="description" content="Who are we?" />
    <meta name="keywords" content="Data Management Service, Bioinformatics Core, BQHS, About, Biostatistics, Quantitative Health Sciences, Hawaii, University of Hawaii, John A. Burns School of Medicine" />
...
<body id="bi-services">
    ...
    <!-- Breadcrumb/Navigational Hierarchy -->
            <div class="hierarchy breadcrumbNav realBreadcrumbNav">
                <ol class="breadcrumb">
                    ...
                    <li class="currentLink"><a href="./DataManagementService.php">Data Management Service</a></li>
                </ol>
            </div><!-- (End Breadcrumb) -->
    ...
    <div class="container mainBody fakeMenuReplace" id="activebisDM">
    ...
    <div class="mainInfo">
        ...
        <div class="rightBank">
            ...
            <!-- Title of Page -->
            <div class="titleOfPage"><p>Data Management Service</p></div>
            ...
            <div class="contentOfPage"> 
                ...
                <p class="contentWords">We will provide data management service and develop a web-based database for collection, storage,
				 integration, and management of clinical data and scientific research data.
                </p>
