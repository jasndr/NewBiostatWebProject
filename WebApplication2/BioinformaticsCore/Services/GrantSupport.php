...
<!-- ######################################################################
     ...
     # @date November 2016                                                #
     # Grant Support- Bioinformatics Core                                #
     ###################################################################### -->
<html>

<head>
    <title>Grant Support | Bioinformatics Core | BQHS</title>
    <link rel="icon" href="../../images/Logo_Final.png" />
	<meta charset="utf-8" />
	<meta http-equiv="X-UA-Compatible" content="IE=10; IE=9; IE=8; IE=7; IE=EDGE" />
    <meta name="description" content="Who are we?" />
    <meta name="keywords" content="Grant Support, Bioinformatics Core, BQHS, About, Biostatistics, Quantitative Health Sciences, Hawaii, University of Hawaii, John A. Burns School of Medicine" />
...
<body id="bi-services">
    ...
    <!-- Breadcrumb/Navigational Hierarchy -->
            <div class="hierarchy breadcrumbNav realBreadcrumbNav">
                <ol class="breadcrumb">
                    ...
                    <li class="currentLink"><a href="./GrantSupport.php">Grant Support</a></li>
                </ol>
            </div><!-- (End Breadcrumb) -->
    ...
    <div class="container mainBody fakeMenuReplace" id="activebisGS">
    ...
    <div class="mainInfo">
        ...
        <div class="rightBank">
            ...
            <!-- Title of Page -->
            <div class="titleOfPage"><p>Grant Support</p></div>
            ...
            <div class="contentOfPage"> 
                ...
                <p class="contentWords">We will provide hardware and software support for UH researchers who plan to conduct preliminary data analysis
				 for hypothesis development and testing as part of grant proposal writing. We will provide necessary guidance to include computational
				  biological methods to analyze data in your research analysis plan. We will also prepare letters of support for your grant proposal.
                </p>
