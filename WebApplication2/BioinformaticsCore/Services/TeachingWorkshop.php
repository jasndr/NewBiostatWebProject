...
<!-- ######################################################################
     ...
     # @date November 2016                                                #
     # Teaching/Workshop - Bioinformatics Core                                #
     ###################################################################### -->
<html>

<head>
    <title>Teaching/Workshop | Bioinformatics Core | BQHS</title>
    <link rel="icon" href="../../images/Logo_Final.png" />
	<meta charset="utf-8" />
	<meta http-equiv="X-UA-Compatible" content="IE=10; IE=9; IE=8; IE=7; IE=EDGE" />
    <meta name="description" content="Who are we?" />
    <meta name="keywords" content="Teaching/Workshop, Bioinformatics Core, BQHS, About, Biostatistics, Quantitative Health Sciences, Hawaii, University of Hawaii, John A. Burns School of Medicine" />
...
<body id="bi-services">
    ...
    <!-- Breadcrumb/Navigational Hierarchy -->
            <div class="hierarchy breadcrumbNav realBreadcrumbNav">
                <ol class="breadcrumb">
                    ...
                    <li class="currentLink"><a href="./TeachingWorkshop.php">Teaching/Workshop</a></li>
                </ol>
            </div><!-- (End Breadcrumb) -->
    ...
    <div class="container mainBody fakeMenuReplace" id="activebisTW">
    ...
    <div class="mainInfo">
        ...
        <div class="rightBank">
            ...
            <!-- Title of Page -->
            <div class="titleOfPage"><p>Teaching/Workshop</p></div>
            ...
            <div class="contentOfPage"> 
                ...
                <p class="contentWords">We have been offering graduate level bioinformatics course each year through the Department of Tropical Medicine,
				 Medical Microbiology, and Pharmacology. We will also offer workshops in the near future depending on the interest of our research community.
                </p>
