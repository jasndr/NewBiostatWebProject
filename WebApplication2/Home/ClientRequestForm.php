<?php 
$your_email ='jdelosr@hawaii.edu';// <<=== update to your email address
...
if(isset($_POST['submit']))
{
	...
	///------------Do Validations-------------
//(HTML ALREADY DOES FIELD VALIDATIONS)
/**	if(empty($name)||empty($visitor_email))
	...
	if(empty($txtCaptchaCode) ||
	  strcasecmp($txtCaptchaCode, $_POST['6_letters_code']) != 0)
	{
...
<body>
    ...
    <form method="post" action="./ClientRequestForm.html" id="requestForm" class="form-horizontal">
                    ...
                    <div class="col-sm-10">
                        <table id="tblStudyArea" class="table">
                            <tr>
                                <td>
                                    <label>
                                        <input name="ctl06" type="checkbox" value="1" />
                                        Aging & Chronic Disease Prevention/Management
                                    </label>
                                </td>
                                <td>
                                    <label>
                                        <input name="ctl08" type="checkbox" value="4" />
                            ...
                            <tr>
                                <td>
                                    <label>
                                        <input name="ctl11" type="checkbox" value="2" />
                                        Cardiovascular Health
                                    </label>
                                </td>
                                <td>
                                    <label>
                                        <input name="ctl13" type="checkbox" value="5" />
                            ...
                            <tr>
                                <td>
                                    <label>
                                        <input name="ctl16" type="checkbox" value="3" />
                                        Cancer Prevention & Health Recovery
                                    </label>
                                </td>
                                <td>
                                    <label>
                                        <input name="ctl18" type="checkbox" value="6" />
                                        Respiratory Health
                                    </label>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <label>
                                        <input name="ctl22" type="checkbox" value="99" />
                                        Other
                                    </label>
                                </td>
                            </tr>
                    ...
                    <div class="col-sm-10">
                        <table id="tblServiceType" class="table">
                            <tr>
                                <td>
                                    <label>
                                        <input name="ctl25" type="checkbox" value="1" />
                                        Study Design
                                    </label>
                                </td>
                                <td>
                                    <label>
                                        <input name="ctl27" type="checkbox" value="4" />
                                        Grant Proposal Development
                                    </label>
                                </td>
                                <td>
                                    <label>
                                        <input name="ctl29" type="checkbox" value="7" />
                                        Education
                                    </label>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <label>
                                        <input name="ctl32" type="checkbox" value="2" />
                                        Database Design & Management
                                    </label>
                                </td>
                                <td>
                                    <label>
                                        <input name="ctl34" type="checkbox" value="5" />
                                        Bioinformatics Analysis
                                    </label>
                                </td>
                                <td>
                                    <label>
                                        <input name="ctl36" type="checkbox" value="9" />
                                        Other
                                    </label>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <label>
                                        <input name="ctl39" type="checkbox" value="3" />
                                        Biostatistical Data Analysis
                                    </label>
                                </td>
                                <td>
                                    <label>
                                        <input name="ctl41" type="checkbox" value="6" />
                                        Dissemination
                                    </label>
                                </td>
                                <td></td>
